...
if st.session_state.page == "À propos":
    ...
    # ==============================================================================
    # SECTION 1 : COMPARATEUR D'HÔTELS (ACCUEIL)
    # ==============================================================================
    ...
    if c_btn2.button("Reset"):
        st.session_state["pays_select"] = ""
        st.session_state["ville_select"] = ""
        st.session_state["choix1_select"] = ""
        st.session_state["choix2_select"] = ""
        st.rerun()
                    ...
                    if tarifs:
                        ...
                        if tarifs_valides:
                            ...
                            for operateur, infos in tarifs_valides.items():
                                ...
                                # Nettoyage et application de l'aid Booking
                        ...
                        # Nettoyage pour le bouton de secours
